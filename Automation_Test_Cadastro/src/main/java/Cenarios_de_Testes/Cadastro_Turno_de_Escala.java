...
public class Cadastro_Turno_de_Escala {

	
	public boolean CT001_Cadastro_Turno_de_Escala(String Nome_Cenario) throws InterruptedException, IOException {
		...
		try {
			...
			//Menu
			System.out.println(Nome_Cenario+": "+ "Menu: "+mt.Menu_Cadastros_TurnodeEscala());
			step.Acessa_Ambiente(Driver,mt.Menu_Cadastros_TurnodeEscala());

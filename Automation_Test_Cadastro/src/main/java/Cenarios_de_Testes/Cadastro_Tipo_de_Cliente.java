...
public class Cadastro_Tipo_de_Cliente {

	
	public boolean CT001_Cadastro_Tipo_de_Cliente(String Nome_Cenario) throws InterruptedException, IOException {
		...
		try {
			...
			//Menu
			System.out.println(Nome_Cenario+": "+ "Menu: "+mt.Menu_Cadastros_TipoCliente());
			step.Acessa_Ambiente(Driver,mt.Menu_Cadastros_TipoCliente());

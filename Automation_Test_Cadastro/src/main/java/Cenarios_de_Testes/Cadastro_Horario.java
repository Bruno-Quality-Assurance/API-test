...
public class Cadastro_Horario {

	
	public boolean CT001_Cadastro_Horario(String Nome_Cenario) throws InterruptedException, IOException {
		...
		try {
			...
			//Menu
			System.out.println(Nome_Cenario+": "+ "Menu: "+mt.Menu_Cadastros_Horario());
			step.Acessa_Ambiente(Driver,mt.Menu_Cadastros_Horario());

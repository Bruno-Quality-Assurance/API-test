...
public class Cadastro_Bairro {

	
	public boolean CT001_Cadastro_Bairro(String Nome_Cenario) throws InterruptedException, IOException {
		...
		try {
			...
			//Menu
			System.out.println(Nome_Cenario+": "+ "Menu: "+mt.Menu_Cadastros_Bairro());
			step.Acessa_Ambiente(Driver,mt.Menu_Cadastros_Bairro());

...
public class Cadastro_Politica_Disciplinar {

	
	public boolean CT001_Cadastro_Politica_Disciplinar(String Nome_Cenario) throws InterruptedException, IOException {
		...
		try {
			...
			//Menu
			System.out.println(Nome_Cenario+": "+ "Menu: "+mt.Menu_Cadastros_PoliticaDisciplinar());
			step.Acessa_Ambiente(Driver,mt.Menu_Cadastros_PoliticaDisciplinar());

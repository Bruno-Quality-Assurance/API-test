...
public class Cadastro_Colaborador {

	
	public boolean CT001_Cadastro_Colaborador(String Nome_Cenario) throws InterruptedException, IOException {
		...
		try {
			...
			//Menu
			System.out.println(Nome_Cenario+": "+ "Menu: "+mt.Menu_Cadastros_Colaborador());
			step.Acessa_Ambiente(Driver,mt.Menu_Cadastros_Colaborador());

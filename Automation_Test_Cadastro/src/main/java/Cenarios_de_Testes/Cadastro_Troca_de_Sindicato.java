...
public class Cadastro_Troca_de_Sindicato {

	
	public boolean CT001_Cadastro_Troca_de_Sindicato(String Nome_Cenario) throws InterruptedException, IOException {
		...
		try {
			...
			//Menu
			System.out.println(Nome_Cenario+": "+ "Menu: "+mt.Menu_Cadastros_TrocadeSindicato());
			step.Acessa_Ambiente(Driver,mt.Menu_Cadastros_TrocadeSindicato());

...
public class Cadastro_Grupo_de_Cargo {

	
	public boolean CT001_Cadastro_Grupo_de_Cargo(String Nome_Cenario) throws InterruptedException, IOException {
		...
		try {
			...
			//Menu
			System.out.println(Nome_Cenario+": "+ "Menu: "+mt.Menu_Cadastros_GrupodeCargo());
			step.Acessa_Ambiente(Driver,mt.Menu_Cadastros_GrupodeCargo());

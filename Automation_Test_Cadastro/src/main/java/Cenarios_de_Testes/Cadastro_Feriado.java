...
public class Cadastro_Feriado {

	
	public boolean CT001_Cadastro_Feriado(String Nome_Cenario) throws InterruptedException, IOException {
		...
		try {
			...
			//Menu
			System.out.println(Nome_Cenario+": "+ "Menu: "+mt.Menu_Cadastros_Feriado());
			step.Acessa_Ambiente(Driver,mt.Menu_Cadastros_Feriado());

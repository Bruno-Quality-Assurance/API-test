...
public class Cadastro_Sindicato {

	
	public boolean CT001_Cadastro_Sindicato(String Nome_Cenario) throws InterruptedException, IOException {
		...
		try {
			...
			//Menu
			System.out.println(Nome_Cenario+": "+ "Menu: "+mt.Menu_Cadastros_Sindicato());
			step.Acessa_Ambiente(Driver,mt.Menu_Cadastros_Sindicato());

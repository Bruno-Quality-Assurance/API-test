...
public class Cadastro_Motivo_de_Ajuste {

	
	public boolean CT001_Cadastro_Area(String Nome_Cenario) throws InterruptedException, IOException {
		...
		try {
			...
			//Menu
			System.out.println(Nome_Cenario+": "+ "Menu: "+mt.Menu_Cadastros_MotivodeAjuste());
			step.Acessa_Ambiente(Driver,mt.Menu_Cadastros_MotivodeAjuste());

...
public class Cadastro_Motivo_de_Encerramento_de_Posto {

	
	public boolean CT001_Cadastro_Motivo_de_Encerramento_de_Posto(String Nome_Cenario) throws InterruptedException, IOException {
		...
		try {
			...
			//Menu
			System.out.println(Nome_Cenario+": "+ "Menu: "+mt.Menu_Cadastros_MotivoEncerramentoPosto());
			step.Acessa_Ambiente(Driver,mt.Menu_Cadastros_MotivoEncerramentoPosto());

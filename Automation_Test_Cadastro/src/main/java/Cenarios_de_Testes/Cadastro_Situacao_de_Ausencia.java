...
public class Cadastro_Situacao_de_Ausencia {

	
	public boolean CT001_Cadastro_Situacao_de_Ausencia(String Nome_Cenario) throws InterruptedException, IOException {
		...
		try {
			...
			//Menu
			System.out.println(Nome_Cenario+": "+ "Menu: "+mt.Menu_Cadastros_SituacaodeAusencia());
			step.Acessa_Ambiente(Driver,mt.Menu_Cadastros_SituacaodeAusencia());

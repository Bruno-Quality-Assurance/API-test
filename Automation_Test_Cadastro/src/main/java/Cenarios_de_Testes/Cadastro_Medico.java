...
public class Cadastro_Medico {

	
	public boolean CT001_Cadastro_Medico(String Nome_Cenario) throws InterruptedException, IOException {
		...
		try {
			...
			//Menu
			System.out.println(Nome_Cenario+": "+ "Menu: "+mt.Menu_Cadastros_Medicos());
			step.Acessa_Ambiente(Driver,mt.Menu_Cadastros_Medicos());

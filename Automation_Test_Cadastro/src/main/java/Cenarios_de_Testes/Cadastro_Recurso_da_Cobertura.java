...
public class Cadastro_Recurso_da_Cobertura {

	
	public boolean CT001_Cadastro_Recurso_da_Cobertura(String Nome_Cenario) throws InterruptedException, IOException {
		...
		try {
			...
			//Menu
			System.out.println(Nome_Cenario+": "+ "Menu: "+mt.Menu_Cadastros_RecursodaCobertura());
			step.Acessa_Ambiente(Driver,mt.Menu_Cadastros_RecursodaCobertura());

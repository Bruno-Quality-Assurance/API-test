...
public class Cadastro_Tipo_de_Servico {

	
	public boolean CT001_Cadastro_Tipo_de_Servico(String Nome_Cenario) throws InterruptedException, IOException {
		...
		try {
			...
			//Menu
			System.out.println(Nome_Cenario+": "+ "Menu: "+mt.Menu_Cadastros_TipodeServico());
			step.Acessa_Ambiente(Driver,mt.Menu_Cadastros_TipodeServico());

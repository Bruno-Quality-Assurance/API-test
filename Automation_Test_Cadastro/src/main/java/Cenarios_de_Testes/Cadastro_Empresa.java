...
public class Cadastro_Empresa {
	...
	public boolean CT001_Cadastro_Empresa(String Nome_Cenario) throws InterruptedException, IOException {
		...
		try {
			...
			//Menu
			System.out.println(Nome_Cenario+": "+ "Menu: "+mt.Menu_Cadastros_Escala());
			step.Acessa_Ambiente(Driver,mt.Menu_Cadastros_Escala());

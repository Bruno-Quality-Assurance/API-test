...
public class Cadastro_CID {

	
	public boolean CT001_Cadastro_CID(String Nome_Cenario) throws InterruptedException, IOException {
		...
		try {
			...
			//Menu
			System.out.println(Nome_Cenario+": "+ "Menu: "+mt.Menu_Cadastros_CID());
			step.Acessa_Ambiente(Driver,mt.Menu_Cadastros_CID());

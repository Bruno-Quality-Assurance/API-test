...
public class Cadastro_Logradouro {

	
	public boolean CT001_Cadastro_Logradouro(String Nome_Cenario) throws InterruptedException, IOException {
		...
		try {
			...
			//Menu
			System.out.println(Nome_Cenario+": "+ "Menu: "+mt.Menu_Cadastros_Logradouro());
			step.Acessa_Ambiente(Driver,mt.Menu_Cadastros_Logradouro());

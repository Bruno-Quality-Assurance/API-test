...
public class Cadastro_Setor {

	
	public boolean CT001_Cadastro_Setor(String Nome_Cenario) throws InterruptedException, IOException {
		...
		try {
			...
			//Menu
			System.out.println(Nome_Cenario+": "+ "Menu: "+mt.Menu_Cadastros_Setor());
			step.Acessa_Ambiente(Driver,mt.Menu_Cadastros_Setor());

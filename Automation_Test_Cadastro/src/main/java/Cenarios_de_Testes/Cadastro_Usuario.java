...
public class Cadastro_Usuario {
	...
	public boolean CT001_Cadastro_Usuario(String Nome_Cenario) throws InterruptedException, IOException {
		...
		try {
			...
			// Menu
			System.out.println(Nome_Cenario + ": " + "Menu: " + mt.Menu_Cadastros_Usuario());
			step.Acessa_Ambiente(Driver, mt.Menu_Cadastros_Usuario());

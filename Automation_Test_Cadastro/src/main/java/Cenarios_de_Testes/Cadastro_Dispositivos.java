...
public class Cadastro_Dispositivos {

	
	public boolean CT001_Cadastro_Dispositivos(String Nome_Cenario) throws InterruptedException, IOException {
		...
		try {
			...
			//Menu
			System.out.println(Nome_Cenario+": "+ "Menu: "+mt.Menu_Cadastros_Dispositivos());
			step.Acessa_Ambiente(Driver,mt.Menu_Cadastros_Dispositivos());

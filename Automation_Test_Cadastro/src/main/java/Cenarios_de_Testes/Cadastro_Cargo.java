...
public class Cadastro_Cargo {

	
	public boolean CT001_Cadastro_Cargo(String Nome_Cenario) throws InterruptedException, IOException {
		...
		try {
			...
			//Menu
			System.out.println(Nome_Cenario+": "+ "Menu: "+mt.Menu_Cadastros_Cargo());
			step.Acessa_Ambiente(Driver,mt.Menu_Cadastros_Cargo());

...
public class Cadastro_Unidade_de_Negocio {

	
	public boolean CT001_Cadastro_Unidade_de_Negocio(String Nome_Cenario) throws InterruptedException, IOException {
		...
		try {
			...
			//Menu
			System.out.println(Nome_Cenario+": "+ "Menu: "+mt.Menu_Cadastros_UnidadedeNegoci());
			step.Acessa_Ambiente(Driver,mt.Menu_Cadastros_UnidadedeNegoci());

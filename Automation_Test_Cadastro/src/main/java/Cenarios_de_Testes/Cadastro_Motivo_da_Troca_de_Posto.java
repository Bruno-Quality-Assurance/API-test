...
public class Cadastro_Motivo_da_Troca_de_Posto {

	
	public boolean CT001_Cadastro_Motivo_da_Troca_de_Posto(String Nome_Cenario) throws InterruptedException, IOException {
		...
		try {
			...
			//Menu
			System.out.println(Nome_Cenario+": "+ "Menu: "+mt.Menu_Cadastros_Area());
			step.Acessa_Ambiente(Driver,mt.Menu_Cadastros_Area());

...
public class Cadastro_Estado_Civil {

	
	public boolean CT001_Cadastro_Estado_Civil(String Nome_Cenario) throws InterruptedException, IOException {
		...
		try {
			...
			//Menu
			System.out.println(Nome_Cenario+": "+ "Menu: "+mt.Menu_Cadastros_EstadoCivil());
			step.Acessa_Ambiente(Driver,mt.Menu_Cadastros_EstadoCivil());

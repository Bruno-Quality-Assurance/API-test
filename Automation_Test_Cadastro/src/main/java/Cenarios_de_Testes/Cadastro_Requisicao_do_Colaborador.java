...
public class Cadastro_Requisicao_do_Colaborador {

	
	public boolean CT001_Cadastro_Requisicao_do_Colaborador(String Nome_Cenario) throws InterruptedException, IOException {
		...
		try {
			...
			//Menu
			System.out.println(Nome_Cenario+": "+ "Menu: "+mt.Menu_Cadastros_RequisicaodoColaborador());
			step.Acessa_Ambiente(Driver,mt.Menu_Cadastros_RequisicaodoColaborador());

...
public class Cadastro_Sancao_Disciplinar {

	
	public boolean CT001_Cadastro_Sancao_Disciplinar(String Nome_Cenario) throws InterruptedException, IOException {
		...
		try {
			...
			//Menu
			System.out.println(Nome_Cenario+": "+ "Menu: "+mt.Menu_Cadastros_SancaoDisciplinar());
			step.Acessa_Ambiente(Driver,mt.Menu_Cadastros_SancaoDisciplinar());

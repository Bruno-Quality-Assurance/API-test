...
public class Cadastro_Bloqueio_de_Posto {

	
	public boolean CT001_Cadastro_Bloqueio_de_Posto(String Nome_Cenario) throws InterruptedException, IOException {
		...
		try {
			...
			//Menu
			System.out.println(Nome_Cenario+": "+ "Menu: "+mt.Menu_Cadastros_Bloqueio_de_Posto());
			step.Acessa_Ambiente(Driver,mt.Menu_Cadastros_Bloqueio_de_Posto());

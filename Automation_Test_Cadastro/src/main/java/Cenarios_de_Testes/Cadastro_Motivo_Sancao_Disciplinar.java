...
public class Cadastro_Motivo_Sancao_Disciplinar {

	
	public boolean CT001_Cadastro_Motivo_Sancao_Disciplinar(String Nome_Cenario) throws InterruptedException, IOException {
		...
		try {
			...
			//Menu
			System.out.println(Nome_Cenario+": "+ "Menu: "+mt.Menu_Cadastros_MotivoSancaoDisciplinar());
			step.Acessa_Ambiente(Driver,mt.Menu_Cadastros_MotivoSancaoDisciplinar());

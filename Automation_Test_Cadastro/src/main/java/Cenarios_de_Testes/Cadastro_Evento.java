...
public class Cadastro_Evento {

	
	public boolean CT001_Cadastro_Evento(String Nome_Cenario) throws InterruptedException, IOException {
		...
		try {
			...
			//Menu
			System.out.println(Nome_Cenario+": "+ "Menu: "+mt.Menu_Cadastros_Eventos());
			step.Acessa_Ambiente(Driver,mt.Menu_Cadastros_Eventos());

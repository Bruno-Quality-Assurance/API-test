...
public class Cadastro_Justificativa_de_Requisicao {

	
	public boolean CT001_Cadastro_Justificativa_de_Requisicao(String Nome_Cenario) throws InterruptedException, IOException {
		...
		try {
			...
			//Menu
			System.out.println(Nome_Cenario+": "+ "Menu: "+mt.Menu_Cadastros_Layout());
			step.Acessa_Ambiente(Driver,mt.Menu_Cadastros_Layout());

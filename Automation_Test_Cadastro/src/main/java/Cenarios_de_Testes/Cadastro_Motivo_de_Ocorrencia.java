...
public class Cadastro_Motivo_de_Ocorrencia {

	
	public boolean CT001_Cadastro_Motivo_de_Ocorrencia(String Nome_Cenario) throws InterruptedException, IOException {
		...
		try {
			...
			//Menu
			System.out.println(Nome_Cenario+": "+ "Menu: "+mt.Menu_Cadastros_MotivodaOcoreencia());
			step.Acessa_Ambiente(Driver,mt.Menu_Cadastros_MotivodaOcoreencia());
